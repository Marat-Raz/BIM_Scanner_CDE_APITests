...
public class CreateProjectTests extends StartTests {
  ...
  CdeCreateProjectDto createProject;
/*
 ...
 */
  ...
  public void createProjectWithoutNameTest() {
    createProject = projectFactory.createProject(PROJECT_WITHOUT_NAME);
    createProjectResponse = projectsClient.createProject(createProject);
  ...
  public void createProjectWithNullTest() {
    createProject = projectFactory.createProject(PROJECT_WITHOUT_DATA);
    createProjectResponse = projectsClient.createProject(createProject);
    statusCode = extractStatusCode(createProjectResponse);
