...
public class AddTopicBoardPriorityToTopicBoardTests extends TopicBoardPriorityBaseTests {
  ...
  public void addPrioritiesToTopicBoardTest() {
    ...
    CdeTopicBoardPriorityDto topicBoardPriority = addPrioritiesResponse.extract()
        .as(CdeTopicBoardPriorityDto.class);

    assertEquals(SC_OK, statusCode);
    assertAll(
        () -> assertEquals(priority.getName(), topicBoardPriority.getName()),
        () -> assertEquals(priority.getColor(), topicBoardPriority.getColor())
    );
  }
}
