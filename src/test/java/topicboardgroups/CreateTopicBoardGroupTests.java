...
public class CreateTopicBoardGroupTests extends TopicBoardGroupBaseTests {
// todo   private ValidatableResponse createResponse;
  ...
  public void createTopicBoardsGroupTest() {
    ...
    assertAll(
        () -> assertEquals("TopicBoardGroup", topicBoardGroup.getType()),
        () -> assertEquals(cdeCreateTopicBoardGroupDto.getName(), topicBoardGroup.getName()),
        () -> assertEquals(projectId, topicBoardGroup.getProjectId())
    );
  }
