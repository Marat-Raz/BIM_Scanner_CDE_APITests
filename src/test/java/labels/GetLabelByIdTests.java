...
public class GetLabelByIdTests extends LabelBaseTests {
  ...
  public void getLabelByIdTest() {
    ...
    assertAll(
        () -> assertEquals(cdeLabels.get(0).getName(), expectedLabel.getName()),
        () -> assertEquals(cdeLabels.get(0).getColor(), expectedLabel.getColor()),
        () -> assertEquals(cdeLabels.get(0).getId(), expectedLabel.getId())
    );
  }
