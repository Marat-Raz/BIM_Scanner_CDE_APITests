...
public class CreateCdeCreateProjectDtoAbpIdentityRoleDtoTests extends ProjectRolesBaseTests {
  ...
  public void createProjectRoleTest() {
    ...
    assertAll(
        () -> assertEquals(defaultCdeCreateProjectRoleDto.getName(), defaultCdeProjectRoleDto.getName()),
        () -> assertEquals(defaultCdeCreateProjectRoleDto.getIsDefault(),
            defaultCdeProjectRoleDto.getIsDefault()),
        () -> assertEquals(defaultCdeCreateProjectRoleDto.getPermissions(),
            defaultCdeProjectRoleDto.getPermissions())
    );
  }
